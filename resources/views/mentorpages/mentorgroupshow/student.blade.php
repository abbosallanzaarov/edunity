...
@section('mentoryield')
    <div class="row   p-2">
        @forelse ($students_mentor as $student)
                    <div class="col-md-4 ">
                        <div class="card card-inverse p-3" style="background-color: #333; border-color: #333;">
                            <div class="card-block">
                                <div class="row">
                                    <div class="col-md-8 col-sm-8">
                                        <h2 class="card-title">Name: {{ $student->full_name }}</h2>
                                    ...
                                    <div class="col-md-4 col-sm-4 text-center">
                                        <img class="btn-md" src="{{ asset($student->image) }}" alt=""
                                            style="border-radius:50%;">
                                    </div>
                                    <div class="col-md-4 col-sm-4 text-center">
                                        <h2><strong></strong></h2>
                                        <p><small>Natijasi</small></p>
                                        <button class="btn btn-warning btn-block btn-md"><span
                                                class="fa fa-facebook-square"></span> {{ $student->balans }} coin</button>
                                    </div>
                                    {{-- <div class="col-md-4 col-sm-4 text-center">
                                        <h2><strong></strong></h2>
                                        <p><small>Qoldirgan</small></p>
                                        <button class="btn btn-success btn-block btn-md"><span
                                                class="fa fa-twitter-square"></span>  </button>
                                    </div> --}}
                                    {{-- <div class="col-md-4 col-sm-4 text-center">
                                        <h2><strong>3.8K</strong></h2>
                                        <p><small>Qarzi</small></p>
