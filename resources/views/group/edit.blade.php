...
@section('content')
    <div class="bs-stepper-content">
        <form action="{{ route('team.update', $team->id) }}" method="post" enctype="multipart/form-data">
            ...
            <div id="account-details-validation"
                ...
                <div class="row g-3">
                    <div class="col-sm-6 fv-plugins-icon-container fv-plugins-bootstrap5-row-valid">
                        ...
                        <input type="text" name="name" id="formValidationUsername" value="{{ $team->name }}"
            ...
            <div class="col-12 d-flex justify-content-between my-3 w-50">
                <input class="form-control" name="length" type="number" placeholder="Davomiyligi oy hisobida" value="{{ $team->length }}">
            </div>
