...
@section('content')
    ...
    <div class="content-wrapper">
            ...
            <h3 class="mt-2" style="color: #FF5733 ;">
                <b>{{Auth::user()->name}} Salom</b>
            </h3>

                    <span class="my-2">Siz uchun Ogahlantirishlar</span>
        <div class="row">
                    ...
                    <div class="row">
                        <div class="col-md-12 stretch-card grid-margin grid-margin-md-0">
                            <div class="card data-icon-card-primary">
                                <div class="card-body">
                                    <p class="card-title text-white">Ogahlantirish vaqti:{{ $warning->creates_at }}</p>
                                    <div class="row">
                                        <div class="col-8 text-white">
                                            <h3>Ogahlantirish raqami:{{ $warning->id }}</h3>
                                            <p class="text-white font-weight-500 mb-0">{{ $warning->warning }}.
                                            </p>
                                        </div>
            ...
            @empty
                <h4 class="">Sizda ogahlantirishlar mavjud emas!</h4>
            @endforelse
        </div>
            ...
            <div class="card-body">
                ...
                <div id="sales-legend" class="chartjs-legend mt-4 mb-2">
                    <ul class="1-legend">
                        ...
                        <li><span style="background-color: rgb(75, 73, 172);">
                            </span>Online Sales</li>
                    </ul>
                </div>
                <canvas id="sales-chart" width="794" height="396" style="display: block; width: 397px; height: 198px;"
