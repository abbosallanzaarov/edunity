                ...
                <form method="POST" action="{{ route('course.store') }}" id="wizard-validation-form">
                    ...
                    <div id="account-details-validation"
                        ...
                        <div class="row g-3">
                            <div class="col-sm-6 fv-plugins-icon-container fv-plugins-bootstrap5-row-valid">
                                ...
                                <input type="text" name="full_name" id="formValidationUsername"
                                    value="{{ old('full_name') }}" class="form-control @error('title') is-invalid @enderror"
                        ...
                        <div class="col-sm-6 fv-plugins-icon-container fv-plugins-bootstrap5-row-invalid">
                            ...
                            <input type="number" name="salary" id="formValidationEmail"
                                class="form-control  @error('title') is-invalid @enderror" value="{{ old('salary') }}"
                                placeholder="1000000" aria-label="">
                            <div class="fv-plugins-message-container invalid-feedback">
                            </div>
                        </div>
                        <div
                            class="col-sm-6 form-password-toggle fv-plugins-icon-container fv-plugins-bootstrap5-row-valid">
                            <label class="form-label" for="formValidationPass">Qisqacha Izoh (Majburi Emas)</label>
                            <div class="input-group input-group-merge has-validation">
                                <input type="text" id="formValidationPass" name="description" class="form-control"
                                    placeholder="TEXT" aria-describedby="formValidationPass2">
                            </div>
                            <div class="fv-plugins-message-container invalid-feedback"></div>
                        </div>
                            ...
                            <tbody class="table-border-bottom-0">
                                @forelse ($courses as $course)
                                    ...
                                    <td>
                                        ...
                                        <a class="dropdown-item" href="{{ route('course.edit', $course->id) }}"><i
                                                class="bx bx-edit-alt me-1"></i> Tahrirlash</a>
