      ...
      <div id="account-details-validation" class="content active dstepper-block fv-plugins-bootstrap5 fv-plugins-framework">
        ...
        <div class="row g-3">
          <div class="col-sm-6 fv-plugins-icon-container fv-plugins-bootstrap5-row-valid">
            ...
            <input type="text" name="full_name" id="formValidationUsername" value="{{$course->full_name}}" class="form-control @error('title') is-invalid @enderror" placeholder="misol:: Matematika">
          ...
          <div class="col-sm-6 fv-plugins-icon-container fv-plugins-bootstrap5-row-invalid">
            ...
            <input type="string" name="salary" id="formValidationEmail" class="form-control  @error('title') is-invalid @enderror" value="{{$course->salary}}" placeholder="1000000" aria-label="">
          <div class="fv-plugins-message-container invalid-feedback">
              @error('salary')
              <div data-field="formValidationEmail" data-validator="notEmpty">{{$message}}</div>
              @enderror
          ...
          <div class="col-sm-6 form-password-toggle fv-plugins-icon-container fv-plugins-bootstrap5-row-valid">
            ...
            <div class="input-group input-group-merge has-validation">
              <input type="text" value="{{$course->description}}" id="formValidationPass" name="description" class="form-control" placeholder="TEXT" aria-describedby="formValidationPass2">
