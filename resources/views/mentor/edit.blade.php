                    ...
                    <div class="row">
                        ...
                        <div class="col-xl-4 col-md-6 col-sm-12 mb-4" method="post" action="#">
                            ...
                            <div class="input-group input-group-merge">
                                <input type="text" name="full_name" id="creditCardMask" value="{{ $mentor->full_name }}"
                                    name="full_name" class="form-control credit-card-mask" placeholder="Name"
                        ...
                        <div class="col-xl-4 col-md-6 col-sm-12 mb-4">
                            ...
                            <div class="input-group">
                                ...
                                <input type="number" name="phone" id="phone-number-mask" value="{{ $mentor->phone }}"
                        ...
                        <div class="col-xl-4 col-md-6 col-sm-12 mb-4">
                            ...
                            <input type="number" value="{{ $mentor->salary }}" name="salary" id="date-mask"
                                class="form-control date-mask" placeholder="Salary" />
                        </div>
                        <!-- Time -->
                        <div class="col-xl-4 col-md-6 col-sm-12 mb-4">
                            <label class="form-label" for="time-mask">Rasm</label>
                            <input type="file" name="image" value="{{ $mentor->image }}" id="time-mask"
                                class="form-control time-mask" placeholder="" />
                        </div>
                        <!-- Numeral Formatting -->
                        <div class="col-xl-4 col-md-6 col-sm-12 mb-4">
                            <label class="form-label" for="numeral-mask">Email </label>
                            <input type="email" value="{{ $mentor->email }}" name="email" id="numeral-mask"
                                class="form-control numeral-mask" placeholder="Email" />
                        </div>
                        <div class="col-xl-4 col-md-6 col-sm-12 mb-4">
                            <label class="form-label" for="numeral-mask">Password </label>
                            <input type="password" value="{{ $mentor->password }}" name="password" id="numeral-mask"
                                class="form-control numeral-mask" placeholder="password" />
                        </div>
                        <!-- button update -->
                        <div class="col-xl-4 col-md-6 col-sm-12 mb-4">
                            <label class="form-label" for="numeral-mask">Tahrirlash </label>
                            <button type="submit" value="Tahrirlash"
                                class="form-control numeral-mask bg-primary text-white">
                                Tahrirlash
                            </button>
                        </div>
